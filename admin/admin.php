...
<body>
    <section id="menu">
        ...
        <div class="items">
            ...
            <li class="active"><i class='bx bxs-id-card'></i><a href="admin.php">Admin</a></li>
            ...
            <table width="100%">
                ...
                <tbody class="featured__container">
                    ...
                    <tr class="featured__card">
                        ...
                        <td class="edit" colspan="2"><a href="admin-edit.php?action=admin-edit&QStrUserID=<?php echo $row['userid']?>"><i class='bx bx-edit-alt'></i>Edit</a></td>
                        <td class="delete"><a href="admin-delete.php?action=admin-delete&QStrUserID=<?php echo $row['userid']?>"><i class='bx bx-trash'></i>Delete</a></td>
                    </tr>
                    <?php } ?>  
