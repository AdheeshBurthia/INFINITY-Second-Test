...
<body>
    <section id="menu">
        ...
        <div class="items">
            ...
            <li class="active"><i class='bx bx-message-dots'></i><a href="admin-message.php">Message</a></li>
            ...
            <table width="100%">
                <thead>
                    <tr>
                        ...
                        <td>Message<i class='bx bx-sort'></i></td>
                        <td>Mobile<i class='bx bx-sort'></i></td>
                ...
                <tbody class="featured__container">
                    ...
                    <?php foreach($listMessage as $row) { ?>
                    <tr class="featured__card">
                        ...
                        <td class="active"><a href="admin-messageview.php?action=admin-messageview&QStrMessageID=<?php echo $row['messageid']?>"><p>View</p></a></td>
                        ...
                        <td class="delete"><a href="admin-messagedelete.php?action=admin-messagedelete&QStrMessageID=<?php echo $row['messageid']?>"><i class='bx bx-trash'></i>Delete</a></td>
                    </tr>
                    <?php } ?>  
