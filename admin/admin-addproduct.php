    ...
    <div class="container">
        <div class="row">
            <div class="col-6 offset-md-3 form-div">
                ...
                <h3 class="text-center">New Product</h3><br>
                    <div class="form-group text-center">
                    <?php $path = '../assets/img/placeholder.png' ?>
                    ...
                    <div class="form-group">
                        ...
                        <input name="productname" id="productname" class="form-control"></input>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="submit" value="Add New Product" name="btnAddProduct" class="btn btn-primary btn-block">
                    </div>
