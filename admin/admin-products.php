...
<body>
    <section id="menu">
        ...
        <div class="items">
            ...
            <li class="active"><i class='bx bx-category'></i><a href="admin-products.php">Product List</a></li>
            ...
            <table width="100%">
                <thead>
                    <tr>
                        ...
                        <td>Description<i class='bx bx-sort'></i></td>
                        <td>Price<i class='bx bx-sort'></i></td>
                        <td>Date view<i class='bx bx-sort'></i></td>
                ...
                <?php foreach($listProducts as $row) { ?>
                    <tr class="featured__card">
                        <td class="people">
                            ...
                            <div class="people-de">
                                <h5>Rolex</h5>
                                <p id="names"><?php echo $row['productname']; ?></p>
                            </div>
                        </td>

                        <td class="active"><a href="admin-productview.php?action=admin-productedit&QStrProdID=<?php echo $row['productid']?>"><p>View</p></a></td>

                        <td class="people-des">
                            <p>Rs <?php echo $row['price']; ?></p>
                        </td>
                        <td class="people-des">
                            <p><?php echo $row['dateview']; ?></p>
                        </td>

                        <td class="edit" colspan="2"><a href="admin-productedit.php?action=admin-productedit&QStrProdID=<?php echo $row['productid']?>"><i class='bx bx-edit-alt'></i>Edit</a></td>
                        <td class="delete"><a href="admin-productdelete.php?action=admin-productdelete&QStrProdID=<?php echo $row['productid']?>"><i class='bx bx-trash'></i>Delete</a></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
