                ...
                <form method="POST" class="form__content">
                    ...
                    <div class="form__div form__div-one">
                        ...
                        <div class="form__div-input">
                            ...
                            <input type="text" class="form__input" name="username" value="<?php echo (isset($_SESSION['username'])) ? $_SESSION['username'] : ''; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form__div">
                        ...
                        <div class="form__div-input">
                            ...
                            <input type="password" class="form__input" name="password" value="<?php echo (isset($_SESSION['password'])) ? $_SESSION['password'] : ''; ?>">
                        </div>
                    </div>
                    <a href="forgotpassword.php" class="form__forgot">Forgot Password?</a>
                    ...
                    <a href="login.php" class="form__signup">Back to login?</a>
